...
/**
 * Entity class representing an employer. Contains details about the company, contact information,
 * and account status.
 *
 * @author KhanhDX
 * @since 1.0.0
...
public class Employer extends BaseEntity implements UserDetails {
  ...
  @OneToMany(mappedBy = "employerAuthor", cascade = CascadeType.ALL, orphanRemoval = true)
