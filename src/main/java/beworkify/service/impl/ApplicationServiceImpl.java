...
public class ApplicationServiceImpl implements ApplicationService {
    ...
    public ApplicationResponse getLatestByJob(Long jobId) {
        Long userId = AppUtils.getUserIdFromSecurityContext();
        Application latest = repository.findTopByUserIdAndJobIdOrderByCreatedAtDesc(userId, jobId)
                .orElseThrow(() -> {
                    String message = messageSource.getMessage("application.notFound", null,
                            LocaleContextHolder.getLocale());
