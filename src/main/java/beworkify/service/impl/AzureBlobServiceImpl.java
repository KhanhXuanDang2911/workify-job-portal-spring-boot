...
public class AzureBlobServiceImpl implements AzureBlobService {
	...
	public String uploadFile(MultipartFile file) {
		...
		try {
			...
			BlockBlobClient blobClient = new BlobClientBuilder().connectionString(connectionString)
					.containerName(containerName).blobName(fileName).buildClient().getBlockBlobClient();
