...
public class RoleServiceImpl implements RoleService {
	...
	public List<RoleResponse> getAllRoles() {
		...
		List<RoleResponse> responses = roles.stream().map(r -> RoleResponse.builder().id(r.getId()).role(r.getRole())
				.description(r.getDescription()).createdAt(r.getCreatedAt()).updatedAt(r.getUpdatedAt()).build())
	...
	public RoleResponse getRoleByRoleName(String roleName) {
		...
		return RoleResponse.builder().id(role.getId()).role(role.getRole()).description(role.getDescription())
	...
	public Role findRoleByRoleName(String roleName) {
		...
		return roleRepository.findByRole(userRole).orElseThrow(() -> {
