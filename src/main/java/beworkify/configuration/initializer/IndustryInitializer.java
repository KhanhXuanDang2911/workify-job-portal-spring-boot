  ...
  private Map<String, List<Entry>> industryEntries() {
    ...
    map.put(
        ...
        List.of(
            ...
            new Entry(
                "Vận chuyển / Giao thông / Kho bãi", "Logistics / Transportation / Warehouse"),
    ...
    map.put(
        ...
        List.of(
            ...
            new Entry(
                "Quảng cáo / Khuyến mãi / Đối ngoại", "Advertising / Promotion / Public Relations"),
    ...
    map.put(
        ...
        List.of(
            ...
            new Entry(
                "Tư vấn quản trị / pháp lý / nhân sự", "Management / Legal / HR Consulting")));
