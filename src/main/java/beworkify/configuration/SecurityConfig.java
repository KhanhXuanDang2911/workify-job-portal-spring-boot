	...
	public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
		http.csrf(AbstractHttpConfigurer::disable).cors(Customizer.withDefaults())
				.authorizeHttpRequests(authorize -> authorize.requestMatchers(WHITE_LIST).permitAll()
						...
						.requestMatchers(HttpMethod.GET, "api/v1/employers/{id}", "api/v1/employers",
								"api/v1/employers/top-hiring")
						.permitAll().requestMatchers(HttpMethod.GET, "api/v1/provinces/**").permitAll()
				...
				.authenticationProvider(userAuthProvider()).authenticationProvider(employerAuthProvider())
