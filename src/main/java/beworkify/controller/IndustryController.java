...
public class IndustryController {
	...
	public ResponseEntity<ResponseData<PageResponse<List<IndustryResponse>>>> getAllWithPagination(
		...
		log.info("Request: Get industries with pageNumber={}, pageSize={}, sorts={}, keyword={}", pageNumber, pageSize,
				sorts, keyword);
		PageResponse<List<IndustryResponse>> response = service.getAllWithPaginationAndSort(pageNumber, pageSize, sorts,
				keyword, categoryId);
		String message = messageSource.getMessage("industry.get.list.success", null, LocaleContextHolder.getLocale());
		return ResponseBuilder.withData(HttpStatus.OK, message, response);
	}
	...
	public ResponseEntity<ResponseData<IndustryResponse>> getById(
		...
		String message = messageSource.getMessage("industry.get.success", null, LocaleContextHolder.getLocale());
		return ResponseBuilder.withData(HttpStatus.OK, message, dto);
	}

	@PostMapping
	@PreAuthorize("hasRole('ADMIN')")
	public ResponseEntity<ResponseData<IndustryResponse>> create(@Valid @RequestBody IndustryRequest request) {
	...
	public ResponseEntity<ResponseData<Void>> delete(
		...
		service.delete(id);
		String message = messageSource.getMessage("industry.delete.success", null, LocaleContextHolder.getLocale());
