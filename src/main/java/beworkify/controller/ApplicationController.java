...
public class ApplicationController {
  ...
  public ResponseEntity<ResponseData<ApplicationResponse>> apply(
    ...
    String message =
        messageSource.getMessage(
            "application.apply.success", null, LocaleContextHolder.getLocale());
  ...
  public ResponseEntity<ResponseData<PageResponse<List<ApplicationResponse>>>> getMyApplications(
    ...
    String message =
        messageSource.getMessage(
            "application.get.list.success", null, LocaleContextHolder.getLocale());
  ...
  public ResponseEntity<ResponseData<PageResponse<List<ApplicationResponse>>>> getByJobId(
      ...
      @RequestParam(required = false)
          ...
          String status) {
    PageResponse<List<ApplicationResponse>> dto =
        service.getApplicationsByJobId(
            pageNumber,
            pageSize,
            jobId,
            receivedWithin,
            status != null ? ApplicationStatus.fromValue(status) : null);
    String message =
        messageSource.getMessage("application.get.success", null, LocaleContextHolder.getLocale());
    return ResponseBuilder.withData(HttpStatus.OK, message, dto);
  }
  ...
  public ResponseEntity<ResponseData<Void>> delete(
    ...
    String message =
        messageSource.getMessage(
            "application.delete.success", null, LocaleContextHolder.getLocale());
  ...
  public ResponseEntity<ResponseData<ApplicationResponse>> changeStatus(
    ...
    String message =
        messageSource.getMessage(
            "application.update.status.success", null, LocaleContextHolder.getLocale());
    return ResponseBuilder.withData(HttpStatus.OK, message, dto);
  }
}
