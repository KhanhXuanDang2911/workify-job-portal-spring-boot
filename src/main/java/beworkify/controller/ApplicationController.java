...
public class ApplicationController {
        ...
        public ResponseEntity<ResponseData<PageResponse<List<ApplicationResponse>>>> getMyApplications(
                ...
                PageResponse<List<ApplicationResponse>> response = service.getMyApplications(pageNumber, pageSize,
                                sorts);
        ...
        public ResponseEntity<ResponseData<PageResponse<List<ApplicationResponse>>>> getByJobId(
                ...
                PageResponse<List<ApplicationResponse>> dto = service.getApplicationsByJobId(pageNumber, pageSize,
                                jobId, receivedWithin, status != null ? ApplicationStatus.fromValue(status) : null);
                String message = messageSource.getMessage("application.get.success", null,
                                LocaleContextHolder.getLocale());
                return ResponseBuilder.withData(HttpStatus.OK, message, dto);
        }
        ...
        public ResponseEntity<ResponseData<Void>> delete(
                ...
                String message = messageSource.getMessage("application.delete.success", null,
                                LocaleContextHolder.getLocale());
