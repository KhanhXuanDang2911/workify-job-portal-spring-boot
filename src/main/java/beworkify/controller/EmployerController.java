...
public class EmployerController {
  ...
  public ResponseEntity<ResponseData<PageResponse<List<EmployerResponse>>>> getEmployers(
      ...
      @ValueOfEnum(
              enumClass = LevelCompanySize.class,
              message = "{error.invalid.level.company.size.enum}",
              required = false)
          @RequestParam(required = false)
          String companySize,
      @Min(value = 1, message = "{validation.province.invalid}") @RequestParam(required = false)
          Long provinceId) {
    ...
    PageResponse<List<EmployerResponse>> response =
        employerService.getEmployersWithPaginationAndKeywordAndSorts(
            pageNumber, pageSize, sorts, keyword, levelCompanySize, provinceId, isAdmin);

    String message =
        messageSource.getMessage(
            "employer.get.many.successfully", null, LocaleContextHolder.getLocale());
  ...
  public ResponseEntity<ResponseData<List<EmployerResponse>>> getTopHiringEmployers(
    ...
    String message =
        messageSource.getMessage(
            "employer.get.top.hiring.success", null, LocaleContextHolder.getLocale());
    return ResponseBuilder.withData(HttpStatus.OK, message, response);
  }
  ...
  public ResponseEntity<ResponseData<EmployerResponse>> getEmployerById(@PathVariable Long id) {
    ...
    String message =
        messageSource.getMessage(
            "employer.get.one.successfully", null, LocaleContextHolder.getLocale());
    return ResponseBuilder.withData(HttpStatus.OK, message, response);
  }
  ...
  public ResponseEntity<ResponseData<EmployerResponse>> signUpEmployer(
    ...
    String message =
        messageSource.getMessage(
            "employer.sign.up.successfully", null, LocaleContextHolder.getLocale());
  ...
  public ResponseEntity<ResponseData<EmployerResponse>> createEmployer(
      @RequestPart("employer") @Validated({OnAdmin.class, Default.class, OnCreate.class})
  ...
  public ResponseEntity<ResponseData<EmployerResponse>> updateEmployer(
    ...
    String message =
        messageSource.getMessage(
            "employer.update.successfully", null, LocaleContextHolder.getLocale());
    return ResponseBuilder.withData(HttpStatus.OK, message, response);
  }
  ...
  public ResponseEntity<ResponseData<Void>> deleteEmployer(@PathVariable Long id) {
    ...
    String message =
        messageSource.getMessage(
            "employer.delete.successfully", null, LocaleContextHolder.getLocale());
  ...
  public ResponseEntity<ResponseData<EmployerResponse>> uploadAvatar(
      @RequestPart("avatar") @ValidImageFile(required = false, message = "image.file.invalid")
          MultipartFile avatar) {
    Long employerId = AppUtils.getEmployerIdFromSecurityContext();
    EmployerResponse response = employerService.uploadAvatar(employerId, avatar);
    String message =
        messageSource.getMessage(
            "employer.avatar.upload.success", null, LocaleContextHolder.getLocale());
    return ResponseBuilder.withData(HttpStatus.OK, message, response);
  }
  ...
  public ResponseEntity<ResponseData<EmployerResponse>> uploadBackground(
      @RequestPart("background") @ValidImageFile(required = false, message = "image.file.invalid")
          MultipartFile background) {
    Long employerId = AppUtils.getEmployerIdFromSecurityContext();
    EmployerResponse response = employerService.uploadBackground(employerId, background);
    String message =
        messageSource.getMessage(
            "employer.background.upload.success", null, LocaleContextHolder.getLocale());
    return ResponseBuilder.withData(HttpStatus.OK, message, response);
  }
  ...
  public ResponseEntity<ResponseData<EmployerResponse>> updateWebsiteUrls(
    ...
    String message =
        messageSource.getMessage(
            "employer.update.website.success", null, LocaleContextHolder.getLocale());
    return ResponseBuilder.withData(HttpStatus.OK, message, response);
  }
}
