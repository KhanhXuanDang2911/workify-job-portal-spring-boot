...
public class EmployerController {
	...
	public ResponseEntity<ResponseData<PageResponse<List<EmployerResponse>>>> getEmployers(
		...
		PageResponse<List<EmployerResponse>> response = employerService.getEmployersWithPaginationAndKeywordAndSorts(
	...
	public ResponseEntity<ResponseData<EmployerResponse>> createEmployer(
			@RequestPart("employer") @Validated({OnAdmin.class, Default.class, OnCreate.class}) EmployerRequest request,
