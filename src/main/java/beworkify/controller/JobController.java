...
public class JobController {
        ...
        public ResponseEntity<ResponseData<PageResponse<List<JobResponse>>>> searchJobsAdvanced(
                ...
                var jobsPage = jobSearchService.searchAdvanced(
                                keyword,
                                industryIds,
                                provinceIds,
                                jobLevels,
                ...
                String message = messageSource.getMessage("job.get.list.success", null,
        ...
        public ResponseEntity<ResponseData<PageResponse<List<JobResponse>>>> getAll(
                ...
                log.info("Request: Get all jobs with pageNumber={}, pageSize={}, sorts={}, keyword={}", pageNumber,
                                pageSize, sorts, keyword);
                PageResponse<List<JobResponse>> response = service.getAllJobs(pageNumber, pageSize, industryId,
                                provinceId,
                                sorts, keyword);
                String message = messageSource.getMessage("job.get.list.success", null,
                                LocaleContextHolder.getLocale());
        ...
        public ResponseEntity<ResponseData<PageResponse<List<JobResponse>>>> getMyJobs(
                ...
                log.info("Request: Get my jobs with pageNumber={}, pageSize={}, sorts={}, keyword={}", pageNumber,
                                pageSize, sorts, keyword);
                PageResponse<List<JobResponse>> response = service.getMyJobs(pageNumber, pageSize, industryId,
                                provinceId,
                                sorts, keyword);
                String message = messageSource.getMessage("job.get.list.success", null,
                                LocaleContextHolder.getLocale());
        ...
        @PostMapping
        @PreAuthorize("hasRole('EMPLOYER')")
        public ResponseEntity<ResponseData<JobResponse>> create(
        ...
        public ResponseEntity<ResponseData<Void>> adminUpdateStatusJob(
                ...
                String message = messageSource.getMessage("job.update.status.success", null,
                                LocaleContextHolder.getLocale());
                return ResponseBuilder.noData(HttpStatus.OK, message);
        }
