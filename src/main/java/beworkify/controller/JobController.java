...
public class JobController {
	...
	public ResponseEntity<ResponseData<PageResponse<List<JobResponse>>>> searchJobsAdvanced(
			@RequestParam(defaultValue = "") String keyword, @RequestParam(required = false) List<String> industryIds,
			@RequestParam(required = false) List<String> provinceIds,
			@RequestParam(required = false) @ValueOfEnumList(enumClass = JobLevel.class, message = "{error.invalid.job.level.enum}") List<String> jobLevels,
			@RequestParam(required = false) @ValueOfEnumList(enumClass = JobType.class, message = "{error.invalid.job.type.enum}") List<String> jobTypes,
			@RequestParam(required = false) @ValueOfEnumList(enumClass = ExperienceLevel.class, message = "{error.invalid.experience.level.enum}") List<String> experienceLevels,
			@RequestParam(required = false) @ValueOfEnumList(enumClass = EducationLevel.class, message = "{error.invalid.education.level.enum}") List<String> educationLevels,
			@RequestParam(required = false) @Min(value = 1, message = "{validation.day.min}") Integer postedWithinDays,
			@RequestParam(required = false) @DecimalMin(value = "0.0", message = "{validation.job.minSalary.min}") Double minSalary,
			@RequestParam(required = false) @DecimalMin(value = "0.0", message = "{validation.job.maxSalary.min}") Double maxSalary,
			@RequestParam(required = false) @ValueOfEnum(enumClass = SalaryUnit.class, message = "{error.invalid.salary.unit.enum}", required = false) String salaryUnit,
		...
		var jobsPage = jobSearchService.searchAdvanced(keyword, industryIds, provinceIds, jobLevels, jobTypes,
				experienceLevels, educationLevels, postedWithinDays, minSalary, maxSalary, salaryUnit, sort, pageable);

		String message = messageSource.getMessage("job.get.list.success", null, LocaleContextHolder.getLocale());
	...
	public ResponseEntity<ResponseData<PageResponse<List<JobResponse>>>> getAll(
			@RequestParam(defaultValue = "1") @Min(value = 1, message = "{validation.page.number.min}") int pageNumber,
			@RequestParam(defaultValue = "10") @Min(value = 1, message = "{validation.page.size.min}") int pageSize,
			@RequestParam(required = false) @Min(value = 1, message = "{validation.id.min}") Long industryId,
			@RequestParam(required = false) @Min(value = 1, message = "{validation.id.min}") Long provinceId,
			@RequestParam(required = false) List<String> sorts, @RequestParam(defaultValue = "") String keyword) {

		log.info("Request: Get all jobs with pageNumber={}, pageSize={}, sorts={}, keyword={}", pageNumber, pageSize,
				sorts, keyword);
		PageResponse<List<JobResponse>> response = service.getAllJobs(pageNumber, pageSize, industryId, provinceId,
				sorts, keyword);
		String message = messageSource.getMessage("job.get.list.success", null, LocaleContextHolder.getLocale());
	...
	public ResponseEntity<ResponseData<PageResponse<List<JobResponse>>>> getMyJobs(
		...
		log.info("Request: Get my jobs with pageNumber={}, pageSize={}, sorts={}, keyword={}", pageNumber, pageSize,
				sorts, keyword);
		PageResponse<List<JobResponse>> response = service.getMyJobs(pageNumber, pageSize, industryId, provinceId,
				sorts, keyword);
		String message = messageSource.getMessage("job.get.list.success", null, LocaleContextHolder.getLocale());
		return ResponseBuilder.withData(HttpStatus.OK, message, response);
	}
	...
	public ResponseEntity<ResponseData<PageResponse<List<JobResponse>>>> getHiringJobs(
		...
		log.info("Request: Get hiring jobs with pageNumber={}, pageSize={}, sorts={}", pageNumber, pageSize, sorts);
		PageResponse<List<JobResponse>> response = service.getHiringJobs(employerId, pageNumber, pageSize, sorts);
		String message = messageSource.getMessage("job.get.hiring.job.success", null, LocaleContextHolder.getLocale());
		return ResponseBuilder.withData(HttpStatus.OK, message, response);
	}
	...
	public ResponseEntity<ResponseData<List<IndustryResponse>>> getMyCurrentIndustries() {
		...
		String message = messageSource.getMessage("industry.get.list.success", null, LocaleContextHolder.getLocale());
		return ResponseBuilder.withData(HttpStatus.OK, message, response);
	}
	...
	public ResponseEntity<ResponseData<List<ProvinceResponse>>> getMyCurrentLocations() {
		...
		String message = messageSource.getMessage("job.location.get.list.success", null,
	...
	public ResponseEntity<ResponseData<JobResponse>> getById(
		...
		String message = messageSource.getMessage("job.get.success", null, LocaleContextHolder.getLocale());
	...
	public ResponseEntity<ResponseData<List<PopularLocationResponse>>> getPopularLocations(
		...
		String message = messageSource.getMessage("job.location.get.popular.success", null,
				LocaleContextHolder.getLocale());
		return ResponseBuilder.withData(HttpStatus.OK, message, response);
	}
	...
	public ResponseEntity<ResponseData<JobResponse>> create(@Valid @RequestBody JobRequest request) {
		...
		String message = messageSource.getMessage("job.create.success", null, LocaleContextHolder.getLocale());
	...
	public ResponseEntity<ResponseData<JobResponse>> update(
		...
		String message = messageSource.getMessage("job.update.success", null, LocaleContextHolder.getLocale());
		return ResponseBuilder.withData(HttpStatus.OK, message, dto);
	}
	...
	public ResponseEntity<ResponseData<Void>> closeJob(
		...
		service.closeJob(id);
		String message = messageSource.getMessage("job.close.success", null, LocaleContextHolder.getLocale());
	...
	public ResponseEntity<ResponseData<Void>> adminUpdateStatusJob(
			@PathVariable("id") @Min(value = 1, message = "{validation.id.min}") Long id,
			@ValueOfEnum(enumClass = JobStatus.class, message = "{error.invalid.job.status.enum}") @RequestParam String status) {
		log.info("Request: Admin update job with id = {}", id);
		service.updateStatus(id, JobStatus.fromValue(status));
		String message = messageSource.getMessage("job.update.status.success", null, LocaleContextHolder.getLocale());
		return ResponseBuilder.noData(HttpStatus.OK, message);
	}
	...
	public ResponseEntity<ResponseData<Void>> delete(
		...
		service.delete(id);
		String message = messageSource.getMessage("job.delete.success", null, LocaleContextHolder.getLocale());
		return ResponseBuilder.noData(HttpStatus.OK, message);
	}
}
