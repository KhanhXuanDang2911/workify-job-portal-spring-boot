...
public class SavedJobController {
	...
	public ResponseEntity<ResponseData<Void>> toggle(
		...
		String message = messageSource.getMessage("saved_job.toggle.success", null, LocaleContextHolder.getLocale());
	...
	public ResponseEntity<ResponseData<PageResponse<List<JobResponse>>>> getSavedJobs(
		...
		String message = messageSource.getMessage("saved_job.get.list.success", null, LocaleContextHolder.getLocale());
	...
	public ResponseEntity<ResponseData<Boolean>> checkSaved(
		...
		String message = messageSource.getMessage("saved_job.check.success", null, LocaleContextHolder.getLocale());
