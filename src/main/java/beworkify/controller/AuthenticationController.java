...
public class AuthenticationController {
  ...
  public ResponseEntity<ResponseData<TokenResponse<EmployerResponse>>> employerSignIn(
    ...
    String message =
        messageSource.getMessage(
            "user.sign.in.successfully", null, LocaleContextHolder.getLocale());
  ...
  public ResponseEntity<ResponseData<TokenResponse<Void>>> refreshTokenUser(
    ...
    String message =
        messageSource.getMessage("auth.refresh.success", null, LocaleContextHolder.getLocale());
    return ResponseBuilder.withData(HttpStatus.OK, message, response);
  }
  ...
  public ResponseEntity<ResponseData<Void>> signOut(
      @RequestHeader("X-Token") String accessToken, @RequestHeader("Y-Token") String refreshToken) {
    authenticationService.signOut(accessToken, refreshToken);
    String message =
        messageSource.getMessage("auth.logout.success", null, LocaleContextHolder.getLocale());
    return ResponseBuilder.noData(HttpStatus.OK, message);
  }

  @PatchMapping(value = "/users/verify-email")
  public ResponseEntity<ResponseData<Void>> verifyEmailUser(
      @RequestHeader("C-Token") String confirmToken) {
    userService.verifyEmailUser(confirmToken);
    String message =
        messageSource.getMessage(
            "user.verify.email.success", null, LocaleContextHolder.getLocale());
    return ResponseBuilder.noData(HttpStatus.OK, message);
  }

  @PatchMapping(value = "/employers/verify-email")
  public ResponseEntity<ResponseData<Void>> verifyEmailEmployer(
      @RequestHeader("C-Token") String confirmToken) {
  ...
  public ResponseEntity<ResponseData<Void>> verifyEmailUserMobile(
      @Valid @RequestBody VerifyEmailMobileRequest request) {
  ...
  public ResponseEntity<ResponseData<Void>> verifyEmailEmployerMobile(
      @Valid @RequestBody VerifyEmailMobileRequest request) {
  ...
  public ResponseEntity<ResponseData<Void>> forgotPasswordUser(
    ...
    String message =
        messageSource.getMessage(
            "auth.forgot.password.success", null, LocaleContextHolder.getLocale());
    return ResponseBuilder.noData(HttpStatus.OK, message);
  }
  ...
  public ResponseEntity<ResponseData<Void>> resetPasswordUser(
      @RequestHeader("R-Token") String token, @Valid @RequestBody ResetPasswordRequest request) {
    userService.resetPassword(token, request);
    String message =
        messageSource.getMessage(
            "auth.reset.password.success", null, LocaleContextHolder.getLocale());
    return ResponseBuilder.noData(HttpStatus.OK, message);
  }

  @PostMapping("/users/mobile/reset-password")
  public ResponseEntity<ResponseData<Void>> resetPasswordUserMobile(
      @Valid @RequestBody ResetPasswordMobileRequest request) {
  ...
  public ResponseEntity<ResponseData<Void>> resetPasswordEmployer(
      @RequestHeader("R-Token") String token, @Valid @RequestBody ResetPasswordRequest request) {
  ...
  public ResponseEntity<ResponseData<Void>> resetPasswordEmployerMobile(
      @Valid @RequestBody ResetPasswordMobileRequest request) {
  ...
  public ResponseEntity<ResponseData<TokenResponse<UserResponse>>> createPassword(
      @RequestHeader("CR-Token") String token, @RequestBody UserCreationPasswordRequest request) {
    TokenResponse<UserResponse> response = userService.createPassword(token, request);
    String message =
        messageSource.getMessage(
            "user.password.create.success", null, LocaleContextHolder.getLocale());
    return ResponseBuilder.withData(HttpStatus.OK, message, response);
  }
}
