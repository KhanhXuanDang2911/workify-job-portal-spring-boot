...
public class KeyGenerator {
  ...
  public static String buildKeyWithPaginationSortsKeywordForIndustries(
      int pageNumber,
      int pageSize,
      List<String> sorts,
      String keyword,
      ...
      Long categoryId) {
    String firstResult =
        buildKeyWithPaginationSortsKeyword(pageNumber, pageSize, sorts, keyword, whiteListFields);
  ...
  public static String buildKeyWithPaginationSortsKeywordForPost(
      int pageNumber,
      int pageSize,
      List<String> sorts,
      String keyword,
  ...
  public static String buildKeyForHiringJobs(
      Long employerId,
      int pageNumber,
      int pageSize,
      List<String> sorts,
      List<String> whiteListFields) {
    String firstResult =
        buildKeyWithPaginationSortsKeyword(pageNumber, pageSize, sorts, null, whiteListFields);
    StringBuilder resultKeyBuilder = new StringBuilder(firstResult);
    if (employerId != null) {
  ...
  public static String buildKeyForGetAllJobs(
      int pageNumber,
      int pageSize,
      Long industryId,
      Long provinceId,
