...
public class KeyGenerator {
	public static String buildKeyWithPaginationSortsKeyword(int pageNumber, int pageSize, List<String> sorts,
			String keyword, List<String> whiteListFields) {
	...
	public static String buildKeyWithPaginationSortsKeywordForPost(int pageNumber, int pageSize, List<String> sorts,
			String keyword, List<String> whiteListFields, Long categoryId, boolean isPublic, Long authorId) {
		String firstResult = buildKeyWithPaginationSortsKeyword(pageNumber, pageSize, sorts, keyword, whiteListFields);
		StringBuilder resultKeyBuilder = new StringBuilder(firstResult);
		if (categoryId != null) {
			resultKeyBuilder.append(":c:").append(categoryId);
	...
	public static String buildKeyForHiringJobs(Long employerId, int pageNumber, int pageSize, List<String> sorts,
			List<String> whiteListFields) {
	...
	public static String buildKeyForGetAllJobs(int pageNumber, int pageSize, Long industryId, Long provinceId,
