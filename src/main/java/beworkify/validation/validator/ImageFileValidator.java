...
public class ImageFileValidator implements ConstraintValidator<ValidImageFile, MultipartFile> {
	...
	private static final Set<String> ALLOWED_TYPES = Set.of("image/jpeg", "image/png", "image/gif", "image/webp",
			"image/bmp", "image/svg+xml", "image/x-icon", "image/vnd.microsoft.icon", "image/tiff", "image/heif",
			"image/heic", "image/avif", "image/jp2", "image/jpx", "image/jpm", "image/mj2", "image/vnd.adobe.photoshop",
			"image/x-portable-bitmap", "image/x-portable-graymap", "image/x-portable-pixmap", "image/x-xbitmap",
			"image/x-xpixmap", "image/x-targa", "image/x-tga", "image/x-pcx", "image/x-canon-cr2", "image/x-canon-cr3",
