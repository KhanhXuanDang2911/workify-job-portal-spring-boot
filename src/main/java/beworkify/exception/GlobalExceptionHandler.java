...
public class GlobalExceptionHandler {
  ...
  public ResponseEntity<ErrorResponse> handleValidationBody(
      MethodArgumentNotValidException e, WebRequest request) {
    String message =
        messageSource.getMessage(
            "error.validation.body.invalid", null, LocaleContextHolder.getLocale());
  ...
  public ResponseEntity<ErrorResponse> handleValidationParams(
      ConstraintViolationException e, WebRequest request) {
    String message =
        messageSource.getMessage(
            "error.validation.params.invalid", null, LocaleContextHolder.getLocale());
    return buildErrorResponse(
        HttpStatus.BAD_REQUEST,
        message,
        request,
  ...
  public ResponseEntity<ErrorResponse> handleInvalidTypeParams(
  ...
  public ResponseEntity<ErrorResponse> handleMissingRequestHeader(
    ...
    String message =
        messageSource.getMessage(
            "error.missing.header", new Object[] {headerName}, LocaleContextHolder.getLocale());
    return buildErrorResponse(HttpStatus.BAD_REQUEST, message, request, null);
  }
  ...
  public ResponseEntity<ErrorResponse> handleMissingParams(
    ...
    String message =
        messageSource.getMessage(
            "error.validation.params.missing",
  ...
  public ResponseEntity<ErrorResponse> handleHttpMessageNotReadable(
    ...
    String message =
        messageSource.getMessage(
            "error.validation.body.not.readable", null, LocaleContextHolder.getLocale());
    ...
    if (cause instanceof InvalidFormatException ife) {
      ...
      if (targetType == Integer.class || targetType == Long.class || targetType == Double.class) {
        message =
            messageSource.getMessage(
                "validation.field.number",
                new Object[] {fieldName},
                LocaleContextHolder.getLocale());
      } else if (targetType == LocalDate.class || targetType == Date.class) {
        message =
            messageSource.getMessage(
                "validation.field.date", new Object[] {fieldName}, LocaleContextHolder.getLocale());
      }
    }
  ...
  public ResponseEntity<?> handleFeignBadRequest(FeignException.BadRequest ex, WebRequest request) {
    String message =
        messageSource.getMessage("error.oauth2", null, LocaleContextHolder.getLocale());
  ...
  public ResponseEntity<ErrorResponse> handleEmailException(MailException e, WebRequest request) {
    String message =
        messageSource.getMessage("error.sendMail", null, LocaleContextHolder.getLocale());
    return buildErrorResponse(HttpStatus.INTERNAL_SERVER_ERROR, message, request, null);
  }
  ...
  public ResponseEntity<ErrorResponse> handleInvalidTokenException(
      UnAuthorizeException e, WebRequest request) {
  ...
  public ResponseEntity<ErrorResponse> handleInvalidTokenException(
    ...
    String message =
        messageSource.getMessage("auth.token.invalid", null, LocaleContextHolder.getLocale());
  ...
  public ResponseEntity<ErrorResponse> handleAccountStatusException(
      AccountStatusException e, WebRequest request) {
    String message =
        messageSource.getMessage("error.disableAccount", null, LocaleContextHolder.getLocale());
    return buildErrorResponse(HttpStatus.UNAUTHORIZED, message, request, null);
  }
  ...
  public ResponseEntity<ErrorResponse> handleSignInException(Exception e, WebRequest request) {
    String message =
        messageSource.getMessage(
            "error.invalid.email.password", null, LocaleContextHolder.getLocale());
    return buildErrorResponse(HttpStatus.UNAUTHORIZED, message, request, null);
  }
  ...
  public ResponseEntity<ErrorResponse> handleInsufficientAuthenticationException(
    ...
    String message =
        messageSource.getMessage(
            "error.insufficientAuthentication", null, LocaleContextHolder.getLocale());
    return buildErrorResponse(HttpStatus.UNAUTHORIZED, message, request, null);
  }
  ...
  public ResponseEntity<ErrorResponse> handleNotFound(
    ...
    String message =
        messageSource.getMessage("error.endpoint.notfound", null, LocaleContextHolder.getLocale());
